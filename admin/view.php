...
<style>
    /* Additional styling for PDF generation (optional) */
    ...
    <main>
        <div class="container">
            ...
            <table id="applicant-table">
                <tbody >
                    <tr>
                        <td colspan="3" rowspan="4" style="text-align: center; align-items: center;">
                    ...
                    <tr>
                        <td colspan="17" >Email: citycollegesfp@gmail.com</td>
                    </tr>
                    <tr>
                        <td colspan="16" >APPLICATION FORM FOR FIRST YEAR</td>                
                        <td colspan="5" rowspan="5" class="photo-td">
                    ...
                    <!-- Courses -->
                    <tr>
                        <td colspan="24">COURSE APPLIED FOR:</td>
                    </tr>
                    <tr>
                        <td colspan="5">1st Choice:</td>
                        <td colspan="14"><input type="text" class="readonly-input" value="<?= htmlspecialchars($applicant['course_first']) ?>" disabled></td>
                    </tr>
                    <tr>
                        <td colspan="5">2nd Choice:</td>
                        <td colspan="14"><input type="text" class="readonly-input" value="<?= htmlspecialchars($applicant['course_second']) ?>" disabled></td>
                    </tr>
                    ...
                    <?php endfor; ?>
                    <!-- Note: The update/delete links were inside the loop; moved them outside to avoid repetition -->
                    <tr>
